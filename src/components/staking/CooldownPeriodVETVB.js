...
const CooldownPeriodVETVB = ({ loadStakingAccount }) => {

    const [periodTime, setPeriodTime] = useState(null);
    const {addressStaking, accountStaked, cooldownSeconds, stakersCooldowns, UNSTAKE_WINDOW, dueTimeEnd } = useSelector((state) => state.accountStakedVETVBReducer,shallowEqual);
...
export default CooldownPeriodVETVB;