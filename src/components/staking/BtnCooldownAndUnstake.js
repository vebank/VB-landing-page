...
const BtnCooldownAndUnstake = ({addressStaking}) => {

  const { accountStaked, cooldownSeconds , stakersCooldowns , UNSTAKE_WINDOW ,dueTimeEnd, loadingCooldown } = useSelector((state) => state.accountStakedVBReducer,shallowEqual);
...
export default BtnCooldownAndUnstake;
